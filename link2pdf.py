...
# down = DownloadVuePress2Pdf("https://v1.vuepress.vuejs.org/zh/guide/", "vuepress指南",
#                             wkhtmltopdf=r"D:\wkhtmltopdf\bin\wkhtmltopdf.exe", save_html_path=r"D:\ppxxfiles", save_pdf_path=r'D:\ppxxout')
# down.down_all_page_to_pdf()

def main():
    url="请在这里输入您需要生成pdf的url:\t"
    name="请在这里输入文件名，不要带有pdf后缀:\t"
    down=DownloadVuePress2Pdf(url,name,
                              wkhtmltopdf=r"D:\wkhtmltopdf\bin\wkhtmltopdf.exe", save_html_path=r"D:\ppxxfiles", save_pdf_path=r'D:\ppxxout')
